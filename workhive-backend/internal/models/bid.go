...
type Bid struct {
	Base
	JobID        uuid.UUID `gorm:"type:uuid;not null;index:idx_bid_job_freelancer,unique" json:"job_id"`
	FreelancerID uuid.UUID `gorm:"type:uuid;not null;index:idx_bid_job_freelancer,unique" json:"freelancer_id"`
