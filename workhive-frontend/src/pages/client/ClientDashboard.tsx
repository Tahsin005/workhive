...
import { useGetClientDashboardQuery } from '@/store/api/dashboardApi'
...
export default function ClientDashboard() {
  ...
  const { data: dashboardData, isLoading: isLoadingDashboard } = useGetClientDashboardQuery()
  ...
  const openJobsCount = stats?.total_jobs || 0
